...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.img_preview = QPushButton(self.centralwidget)
        self.img_preview.setObjectName(u"img_preview")
        self.img_preview.setGeometry(QRect(192, 112, 1536, 856))
        # self.img_preview.setIcon(icon)
        # self.img_preview.setIconSize(QSize(464, 206))
        self.img_preview.setFlat(True)
        self.img_preview.setVisible(False)
        self.img_preview.setStyleSheet("background-color: black; border: 2")
        # self.img_preview = QLabel(self.centralwidget)
        # self.img_preview.setObjectName(u"img_preview")
        # self.img_preview.setGeometry(QRect(192, 112, 1536, 856))
